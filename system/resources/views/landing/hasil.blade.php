        ...
        <div class="container text-center py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4">Teridentifikasi</h1>
                    <h1 class="display-1">{{ $hasil->Seksi->nama_edukasi }}</h1>
                    <h1 class="mb-4">Pertolongan Pertama</h1>
                    {!! $hasil->Seksi->penanganan !!}
                    @php
                        $id_jenis = $hasil->Seksi->id_jenis_edukasi;
                    ...
                    <a class="btn btn-success rounded-pill py-3 px-5"
                        href='{{ url("tertangani/$id_jenis/$hasil->id_deskripsi") }}'>Kembali</a>
